...
if(isset($_POST['submit'])){
  ...
  $sql="UPDATE employee set fullname='$fullname',phone='$phone',date_of_birth='$date_of_birth',email='$email',address='$address',experience='$experience',gender='$gender',skills='$skills' where employee_id='$id'";
      ...
      <form  method="post">
        <div class="row">
          <div class="col-50">
            ...
            <input type="text" name="address" value="<?php echo $data['address']?>" pattern="[A-Za-z]+" required class="form-control input-sm">
            ...
            <input type="text" name="skills" value="<?php echo $data['skills']?>" pattern="^[A-Za-z]+(\s*,?\s*[A-Za-z]+)*$" required class="form-control input-sm"  >
        ...
        <button type="submit" name="submit" class="btn btn-primary" onclick="return confirm('Are you sure you wanna edit?')">Edit Employee</button><br><br>
      </form>
    </div>
  </div>
 </div>
