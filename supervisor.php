...
<?php include("top_nav.php"); ?>
    ...
    <div class="container" style="margin-top:70px;">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header text-primary"><i class='fa fa-user '></i> Supervisor Login.</h1> 
            </div>
			<div class="row">
				...
				if(isset($_POST['submit'])){
					...
					if(empty($username) || empty($password)){
						...
						$hash = md5($password);
						$sql1 = "SELECT * FROM supervisor WHERE username='$username'";
				...
				?>
					<form role="form" action="supervisor.php" method="post">
