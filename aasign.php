	...
	<table border="1" style="width:50%" id="table">
		...
		<tbody>
            ...
            <td style='padding-left: 45px;'><?php echo $d['employee_id']; ?></td>
                ...
                <td style='padding-left: 30px;'><?php echo $d['assigncourse']; ?></td>

		        <td  style='padding-left: 5px;'>

                <a href="aemployeeassign.php?id=<?php echo $d['employee_id']?>" onclick="return confirm('Are you sure you want to assign training?')">
